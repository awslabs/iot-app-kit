      ...
      items={[
        {
          ...
          description: 'Dashboard component allows you to easily create, modify, view, and organize widget-instance for a tailored experience to monitor your IoT data.',
        },
        {
          name: 'KPI',
