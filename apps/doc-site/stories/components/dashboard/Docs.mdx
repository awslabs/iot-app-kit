...
IoT dashboard component allows you to visualize and interact with operational data from AWS IoT SiteWise with a drag-and-drop dashboard building experience.

The dashboard features include:

- A resource explorer to navigate [IoT Sitewise assets](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/industrial-asset-models.html).
- A grid with intuitive drag and drop support for IoT App Kit components.
- Configuration of panels to edit dashboards.
- Add [IoT Sitewise alarms](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/industrial-alarms.html) to your dahsboard widgets.


<Canvas sourceState="none"  story={{height : '450px' }}  of={DashboardStories.Empty} />
