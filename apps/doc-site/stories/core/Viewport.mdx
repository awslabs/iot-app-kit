...
A viewport is a common concept across IoT App Kit, and is managed through the [useViewport hook](/iot-app-kit/?path=/docs/react-hooks-useviewport--docs) and the [ViewportManager](/iot-app-kit/?path=/docs/components-viewportmanager--docs).
