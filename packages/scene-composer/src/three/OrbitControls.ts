...
class OrbitControls extends EventDispatcher {
  ...
  listenToWindowKeyEvents: (window: Window) => void
  saveState: () => void
  reset: () => void
  update: () => void
  ...
  constructor(object: Camera, domElement?: HTMLElement) {
    ...
    this.listenToWindowKeyEvents = (window: Window): void => {
      window.addEventListener('keydown', onKeyDown)
      this._windowKeyEvents = window
    }
    ...
    this.dispose = (): void => {
      ...
      if (scope._windowKeyEvents !== null) {
        scope._windowKeyEvents.removeEventListener('keydown', onKeyDown)
      }
