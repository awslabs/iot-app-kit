...
const colorMap: Record<string, Color> = Object.fromEntries(
  Object.entries({
    red: new Color(hexColorFromDesignToken(awsui.colorBackgroundNotificationRed)),
    green: new Color(hexColorFromDesignToken(awsui.colorBackgroundNotificationGreen)),
    blue: new Color(hexColorFromDesignToken(awsui.colorBackgroundNotificationBlue)),
    yellow: new Color(0xff9900),
    cyan: new Color(0x00a1c9),
    magenta: new Color(0xff5d64),
    gray: new Color(hexColorFromDesignToken(awsui.colorBorderButtonNormalDefault)),
  }).map(([name, color]) => {
