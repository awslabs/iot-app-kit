...
jest.doMock('../../../src/components/three-fiber/GLTFLoader', () => {
  const originalModule = jest.requireActual('../../../src/components/three-fiber/GLTFLoader');
  return {
    ...originalModule,
    useGLTF: mockUseGLTF,
  };
...
jest.doMock('../../../src/utils/objectThreeUtils', () => {
  const originalModule = jest.requireActual('../../../src/utils/objectThreeUtils');
  return {
    ...originalModule,
...
import { IModelRefComponentInternal, useStore } from '../../../src/store';
import { GLTFModelComponent } from '../../../src/components/three-fiber/GLTFModelComponent';
import { KnownComponentType } from '../../../src';
import { getScaleFactor } from '../../../src/utils/mathUtils';
