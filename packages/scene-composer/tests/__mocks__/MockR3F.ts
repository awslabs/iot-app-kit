...
export const mockR3F = () => {
  ...
  jest.doMock('@react-three/drei/core/GizmoHelper', () => ({
    GizmoHelper: 'GizmoHelper',
  }));
  jest.doMock('@react-three/drei/core/GizmoViewport', () => ({
    GizmoViewport: 'GizmoViewport',
  }));
  jest.doMock('@react-three/postprocessing', () => ({
