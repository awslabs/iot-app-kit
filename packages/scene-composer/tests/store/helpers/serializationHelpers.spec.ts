...
describe('serializationHelpers', () => {
  ...
  it('should appropriately create model ref components or log errors when calling createModelRefComponent', () => {
    jest.spyOn(MathUtils, 'generateUUID').mockReturnValueOnce('test-uuid');
    jest.spyOn(MathUtils, 'generateUUID').mockReturnValueOnce('other-test-uuid');
  ...
  describe('deserializeComponent', () => {
    ...
    it('should create a tag', () => {
      ...
      const deserializedComponent = exportsForTesting.deserializeComponent(component as any, resolver, [], {});
    ...
    it('should create a camera', () => {
      ...
      exportsForTesting.deserializeComponent(component as any, resolver, [], {});
    ...
    it('should create a motion indicator when enabled', () => {
      ...
      expect(deserializedComponent).toEqual(component);
      expect(
        exportsForTesting.deserializeComponent(component as any, resolver, [], { disableMotionIndicator: true }),
      ).toBeUndefined();
    });
  ...
  it('should create a document state from a given scene', () => {
    jest.clearAllMocks();
    let idCount = 0;
    jest.spyOn(MathUtils, 'generateUUID').mockImplementation(() => {
      idCount++;
