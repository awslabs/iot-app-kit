...
## [6.4.0](https://github.com/awslabs/iot-app-kit/compare/scene-composer-v6.3.1...scene-composer-v6.4.0) (2023-07-07)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @iot-app-kit/related-table bumped from 6.3.1 to 6.4.0
    * @iot-app-kit/source-iottwinmaker bumped from 6.3.1 to 6.4.0
  * devDependencies
