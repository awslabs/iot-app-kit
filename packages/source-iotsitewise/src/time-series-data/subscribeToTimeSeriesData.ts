import { DataModule, DataModuleSubscription, TimeSeriesData, SubscriptionUpdate } from '@iot-app-kit/core';
...
export const subscribeToTimeSeriesData =
  (dataModule: DataModule, assetModuleSession: SiteWiseAssetSession, alarmModule: SiteWiseAlarmModule) =>
