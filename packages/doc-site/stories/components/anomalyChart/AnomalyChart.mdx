...
Timezone must be specified as an [IANA timezone string](https://ftp.iana.org/tz/tzdb-2020f/zone1970.tab). If this property is provided, the chart will display all dates in the provided timezone, otherwise it will use the browsers local timezone.

#### tooltipSort (string, optional): 
