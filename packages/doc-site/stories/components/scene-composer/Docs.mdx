...
#### dataBindingTemplate (object, optional): 
...
#### onSelectionChanged (object, optional): 
...
#### selectedDataBinding (object, optional): 
...
#### dracoDecoder (object, optional): 

Specifies the configurations for a draco decoder. More information is found in the 
 [AWS IoT Twinmaker User Guide](https://docs.aws.amazon.com/iot-twinmaker/latest/guide/scenes-before-starting.html).

#### locale (string, optional): 

Specifies the language for the texts displayed in the component. Default to `en-US`. The supported locales 
