...
**axis** (optional): This specifies x and y-axis related settings. Default value is `{ showX: true, showY: true, yAxisLabel: undefined }`.
...
**fontSettings** (optional): This specifies the chart's font color and font size. Default value is `undefined`.
...
**legend** (optional): This specifies the color and position of the legend section. Default value is `undefined`.
