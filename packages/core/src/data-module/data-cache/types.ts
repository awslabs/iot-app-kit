...
export interface TTLDurationMapping {
...
export interface DataStreamStore extends Omit<DataStream, 'data'> {
  id: string;
  resolution: number;
...
export interface DataStoreForID {
  resolutions?:
...
export interface DataStreamsStore {
