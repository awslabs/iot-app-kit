...
export const KPIWidgetComponent = ({
  ...
  const aggregation =
    widget.properties.queryConfig?.query?.requestSettings?.aggregationType ??
    widget.properties.queryConfig?.query?.properties?.[0].aggregationType ??
    widget.properties.queryConfig?.query?.assets?.[0].properties?.[0]
      .aggregationType ??
    widget.properties.queryConfig?.query?.assetModels?.[0].properties?.[0]
      .aggregationType;
