...
import { type TextWidgetProperties } from '~/plugins/text/types';
import { TextWidgetComponent } from '~/plugins/text/component';
...
function TextTextWidget(props: TextWidgetProperties) {
  return (
    <TextWidgetComponent
      widget={{
        id: 'id',
...
function TestReadonlyTextWidget(props: TextWidgetProperties) {
  vi.spyOn(ReactRedux, 'useSelector').mockReturnValueOnce(true);

  return <TextTextWidget {...props} />;
}

function TestEditableTextWidget(props: TextWidgetProperties) {
