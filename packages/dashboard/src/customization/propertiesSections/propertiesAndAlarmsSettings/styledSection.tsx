...
export const StyledPropertiesAlarmsSection: FC<StyledPropertiesAlarmsSectionProps> = ({
  ...
  const getComponents = () => {
    ...
    const onUpdatePropertyStyles = (updatedAssetId: string, updatedPropertyId: string, newStyles: any) => {
      const newQuery = {
        ...styledAssetQuery,
        assets:
      ...
      properties.map((property) =>
        describedAssetsMap[assetId] ? (
          <StyledPropertyComponent
            ...
            property={property}
            updateStyle={(newStyles: any) => onUpdatePropertyStyles(assetId, property.propertyId, newStyles)}
