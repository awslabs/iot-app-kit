...
const LEFT_WIDTH_PERCENT = 0.2;
const RIGHT_WIDTH_PERCENT = 0.2;
const MINIMUM_CENTER_PANE_WIDTH = 100;
const MINIMUM_SIDE_PANE_WIDTH = 100;
const HANDLE_WIDTH = 10;
const MAXIMUM_PANES_PROPORTION = 0.8;
...
export const ResizablePanes: FC<ResizablePanesProps> = ({ leftPane, centerPane, rightPane }) => {
  ...
  return (
    ...
    >
      ...
      <div className="iot-resizable-panes-pane iot-resizable-panes-pane-center">
        {centerPane}
      </div>
