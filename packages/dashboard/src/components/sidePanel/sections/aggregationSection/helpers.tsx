...
export const getAggregationOptions = (chartType: string, dataTypes: Set<string>, resolution?: string) => {
...
export const getResolutionOptions = (chartType: string) => {
  switch (chartType) {
    case 'bar-chart':
      return RESOLUTION_OPTIONS.filter((option: SelectProps.Option) => option.value !== '0');
    default:
