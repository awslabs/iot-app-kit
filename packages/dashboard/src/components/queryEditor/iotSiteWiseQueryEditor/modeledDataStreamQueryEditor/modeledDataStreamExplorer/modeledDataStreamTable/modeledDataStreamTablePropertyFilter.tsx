...
type ModeledDataStreamPropertyFilterProps = Omit<
  PropertyFilterProps,
  'i18nStrings'
>;

export function ModeledDataStreamTablePropertyFilter(
  props: ModeledDataStreamPropertyFilterProps
) {
  return (
    <>
      ...
      <PropertyFilter
        ...
        i18nStrings={{
          filteringAriaLabel:
            'Filter modeled data streams by text, property, or value',
