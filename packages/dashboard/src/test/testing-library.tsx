...
interface ExtendedRenderOptions extends RenderOptions {
  ...
  store?: Store;
  metaContextState?: Partial<MetaContextState>;
}
...
function render(
  ...
  const metaContextState: MetaContextState = {
    ...initialMetaContextState,
    ...extendedRenderOptions.metaContextState,
  };

  const Wrapper = ({ children }: PropsWithChildren) => (
    <MetaContext.Provider value={metaContextState}>
