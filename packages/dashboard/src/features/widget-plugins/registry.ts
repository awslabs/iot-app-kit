...
import { type WidgetSettingPath } from '~/features/widget-customization/settings/types';
...
> = {
  [WidgetType in RegisteredWidgetType]: SettingPath extends WidgetSettingPath<WidgetType>
    ? WidgetType
    : never;
}[RegisteredWidgetType];

export type Test = RegisteredWidgetTypeWithSetting<'properties.title'>;

export const t: Test = 'xy-plot';
