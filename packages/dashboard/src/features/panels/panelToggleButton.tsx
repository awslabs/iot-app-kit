import CloudscapeIcon, {
  type IconProps as CloudscapeIconProps,
} from '@cloudscape-design/components/icon';
import { useCallback, type PropsWithChildren } from 'react';
import styled from 'styled-components';
import { type EditMode, type ViewMode } from '#features/mode/types';
import { useStoreDispatch, useStoreSelector } from '#store/hooks';
import { closePanel, openPanel, type PanelState } from './store';
