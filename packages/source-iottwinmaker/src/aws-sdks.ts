...
export const sitewiseSdk = (
  ...
  new IoTSiteWiseClient({
    region: awsRegion || DEFAULT_REGION,
    endpoint: `https://iotsitewise.${
      awsRegion || DEFAULT_REGION
    }.amazonaws.com/`,
    credentials,
  });

export const kinesisVideoSdk = (
  credentials: Credentials | Provider<Credentials>,
  awsRegion?: string
) =>
...
export const kinesisVideoArchivedMediaSdk = (
  credentials: Credentials | Provider<Credentials>,
  awsRegion?: string
) =>
...
export const secretsManagersdk = (
  credentials: Credentials | Provider<Credentials>,
  awsRegion?: string
) =>
