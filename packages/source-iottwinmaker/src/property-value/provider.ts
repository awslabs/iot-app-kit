import { DataRequest, Provider, ProviderObserver, DataBase, DataStreamBase, Primitive } from '@iot-app-kit/core';
 ...
 */
export class TwinMakerPropertyValueDataProvider implements Provider<DataBase[] | undefined> {
  ...
  constructor(
    ...
    this.observer = new QueryObserver(queryClient, {
      ...
      queryFn: async () => {
        try {
          const promises: Promise<DataStreamBase<Primitive>[]>[] = [];
  ...
  subscribe = (observer: ProviderObserver<DataBase[] | undefined>) => {
