...
const items: Item[] = [
  {
    ...
    torque: {
      $cellRef: {
        id: toId({ assetId: DEMO_ASSET, propertyId: DEMO_TURBINE_ASSET_1_PROPERTY_4 }),
        resolution: 0,
      },
    },
    myLabel: 'Iot',
  },
  {
    rpm: {
      $cellRef: {
        id: toId({ assetId: DEMO_TURBINE_ASSET_2, propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_1 }),
        resolution: 0,
      },
    },
    avg_wind_speed: {
      $cellRef: {
        id: toId({ assetId: DEMO_TURBINE_ASSET_2, propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_2 }),
        resolution: 0,
      },
    },
    torque: {
      $cellRef: {
        id: toId({ assetId: DEMO_TURBINE_ASSET_2, propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_3 }),
        resolution: 0,
      },
    },
    myLabel: 'App',
  },
  {
    rpm: {
      $cellRef: {
        id: toId({ assetId: DEMO_TURBINE_ASSET_3, propertyId: DEMO_TURBINE_ASSET_3_PROPERTY_1 }),
        resolution: 0,
      },
    },
    avg_wind_speed: {
      $cellRef: {
        id: toId({ assetId: DEMO_TURBINE_ASSET_3, propertyId: DEMO_TURBINE_ASSET_3_PROPERTY_2 }),
        resolution: 0,
      },
    },
    torque: {
  ...
  y: [
    {
      ...
      dataStreamIds: [toId({ assetId: DEMO_TURBINE_ASSET_2, propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_2 })],
    },

    {
      ...
      dataStreamIds: [
        ...
        toId({ assetId: DEMO_TURBINE_ASSET_2, propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_1 }),
        toId({ assetId: DEMO_TURBINE_ASSET_3, propertyId: DEMO_TURBINE_ASSET_3_PROPERTY_1 }),
      ],
    },
  ],
};
              ...
              this.query.timeSeriesData({
                assets: [
                  ...
                  },
                  {
                    ...
                    properties: [
                      { propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_1 },
                      { propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_2 },
                      { propertyId: DEMO_TURBINE_ASSET_2_PROPERTY_3 },
                    ],
                  },
                  {
