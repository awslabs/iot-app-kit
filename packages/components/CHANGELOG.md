...
## [2.2.1](https://github.com/awslabs/iot-app-kit/compare/components-v2.2.0...components-v2.2.1) (2022-10-27)
...
* The following workspace dependencies were updated
  * dependencies
    * @iot-app-kit/core bumped from ^2.2.0 to ^2.2.1
    * @iot-app-kit/related-table bumped from ^2.2.0 to ^2.2.1
    * @iot-app-kit/source-iotsitewise bumped from ^2.2.0 to ^2.2.1
    * @iot-app-kit/table bumped from ^2.2.0 to ^2.2.1
