...
## [2.2.1](https://github.com/awslabs/iot-app-kit/compare/react-components-v2.2.0...react-components-v2.2.1) (2022-10-27)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @iot-app-kit/components bumped from ^2.2.0 to ^2.2.1
    * @iot-app-kit/source-iottwinmaker bumped from ^2.2.0 to ^2.2.1
