...
export const DEBUG_TREND_CURSORS =
  localStorage.getItem('DEBUG_TREND_CURSORS') ?? false;
export const TREND_CURSOR_HEADER_COLORS = [
  '#DA7596',
  '#2EA597',
  '#688AE8',
  '#A783E1',
...
export const TREND_CURSOR_CLOSE_BUTTON_Y_OFFSET =
  TREND_CURSOR_HEADER_OFFSET + 0.5;
