...
export const ChatbotAssistantMessage = ({ text, citations }: ChatbotAssistantMessageProps) => {
  return (
    <Grid
      gridDefinition={[ 
    ...
    >
      <img alt='Assistant Avatar' src={assistantIcon} width={24} className="assistant-icon" />
