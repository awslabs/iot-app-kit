  ...
  describe('request handling', () => {
    ...
    it('requests multiple lists of pages of asset models correctly', async () => {
      const listAssetModels = jest
        ...
        .mockResolvedValueOnce(createListAssetModelsPage(1, 50, 'next-token-3'))
        .mockResolvedValueOnce(createListAssetModelsPage(1, 60))
        .mockResolvedValueOnce(createListAssetModelsPage(1, 70, 'next-token-4'))
        .mockResolvedValueOnce(createListAssetModelsPage(1, 80));
      ...
      expect(listAssetModels).toHaveBeenCalledTimes(8);
    });
  });
