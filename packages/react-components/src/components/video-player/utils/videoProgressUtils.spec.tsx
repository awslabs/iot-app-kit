...
} from './videoProgressUtils';

it('should return video progress percentage', () => {
  expect(
    getVideoProgressPercentage(1665583620000, 20, 1665583520000, 1665583720000)
  ).toEqual(60);
});

it('should return video seek time according to percentage', () => {
  expect(getVideoProgressSeekTime(60, 1665583520000, 1665583720000)).toEqual(
    1665583640000
  );
});
...
it('should set valid tooltip on video progress', () => {
  ...
  expect(getVideoProgressTooltip(seekTime, startTime)).toEqual(
    `10/12\n14:07:00`
  );
});
