...
export const AppKitContext = createContext<IAppKitConfig>(DEFAULT_APP_KIT_CONFIG);
...
export const AppKitConfig: React.FC<AppKitConfigProps> = ({ children, customFeatureConfig }) => {
  const value = { featureFlagConfig: { ...DEFAULT_APP_KIT_CONFIG.featureFlagConfig, ...customFeatureConfig } };
