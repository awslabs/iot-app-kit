...
const TEST_PAGE_SCATTER_CHART = '/?path=/story/widgets-charts--scatter-chart-example';
const TEST_PAGE_BAR_CHART = '/?path=/story/widgets-charts--bar-chart-example';
const TEST_PAGE_STATUS_TIMELINE = '/?path=/story/widgets-charts--status-timeline-example';
