...
const TEST_PAGE = '/iframe.html?args=&id=widget-instance-gauge--default-gauge';
const TEST_PAGE_HIDDEN_SETTINGS =
  '/iframe.html?args=&id=widget-instance-gauge--hidden-settings-gauge';
const THRESHOLD_TEST_PAGE =
  '/iframe.html?args=&id=widget-instance-gauge--threshold-gauge';
const DELETABLE_THRESHOLD_TEST_PAGE =
  '/iframe.html?args=&id=widget-instance-gauge--deleteable-thresholds-gauge';
