...
import { useSiteWiseL4EAnomaly } from '../../src/queries/useSiteWiseL4EAnomaly';
...
const RenderL4EAnomalyQuery = () => {
  ...
  const { asset, anomalyModel, anomalyEvents, properties } =
    useSiteWiseL4EAnomaly({
      client,
      viewport,
      assetId: ASSET_ID,
  ...
  console.log({ asset, anomalyModel, properties, anomalyEvents });
  return (
    <TimeSync>
      <RenderQueries
        json={{ asset, anomalyModel, anomalyEvents, properties }}
      />
    </TimeSync>
  );
};
